...
:::{.column width=70%}
![](figures/wfdiagram2.png){width=80%}
:::
...
```
  ...
  <!-- ![](figures/cont_dens.png){width=100%} -->
  <!-- ![](figures/cont_ecdf.png){width=100%} -->
  <!-- ![](figucont_qdots.png.png){width=100%} -->
:::
::::
...
### Current stage
 ...
 - Finalizing a submission to Journal of Visualization and Interaction (JoVI)
